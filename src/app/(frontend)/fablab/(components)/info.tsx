...
import { clipPathRevealRL, clipPathRevealTB, fadeUpVariant } from '@/motion/variants'
...
const Info = () => {
  ...
  */
  ...
  const imageScale = useTransform(coverScrollProgress, [0, 1], [1, 1.1])
    ...
    <section className="relative py-4 sxl:py-10 px-4 md:px-10 4xl:px-14 w-full">
      <div className="w-full flex flex-col gap-8 md:flex-row md:w-[80%]">
        <motion.div
          ...
          variants={clipPathRevealTB(2.0, 0)}
          initial="hidden"
          ...
          <div className="flex flex-col gap-10 3xl:gap-12">
            <div className="flex justify-end w-full">
              <motion.div
                ...
                variants={clipPathRevealRL(1.2, 0)}
                initial="hidden"
                whileInView="visible"
